...
while i <= 24:
    ...
    payload = { 
        ...
        'email': 'examination' + (str(random.randint(10000, 99999))) + '@check.exercise.com',
        'firstname': 'CheckFirstName' + (str(random.randint(100, 999))),
        'lastname': 'CheckLastName' + (str(random.randint(100, 999))),
    ...
    headers = {'key': 'wKjAf7ks5LyeBkewY33lsxQa7zhf8hBB'}
