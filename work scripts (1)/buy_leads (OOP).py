...
class BuyLeads(unittest.TestCase):
    ...
    def test_buy_leads(self):
        try:
            ...
            button1 = driver.find_element(By.XPATH,"//element[@id='mainContent']/element/form/element[9]/table/tbody/tr[1]/td")
            driver.execute_script("arguments[0].click();", button1)
            button2 = driver.find_element(By.XPATH,"//element[@id='mainContent']/element/form/element[9]/table/tbody/tr[2]/td")
            driver.execute_script("arguments[0].click();", button2)
            button3 = driver.find_element(By.XPATH,"//element[@id='mainContent']/element/form/element[9]/table/tbody/tr[3]/td")
            driver.execute_script("arguments[0].click();", button3)
            button4 = driver.find_element(By.XPATH,"//element[@id='mainContent']/element/form/element[9]/table/tbody/tr[4]/td")
            driver.execute_script("arguments[0].click();", button4)
            button5 = driver.find_element(By.XPATH,"//element[@id='mainContent']/element/form/element[9]/table/tbody/tr[5]/td")
            driver.execute_script("arguments[0].click();", button5)
            button6 = driver.find_element(By.XPATH,"//element[@id='mainContent']/element/form/element[9]/table/tbody/tr[6]/td")
            driver.execute_script("arguments[0].click();", button6)
            button7 = driver.find_element(By.XPATH,"//element[@id='mainContent']/element/form/element[9]/table/tbody/tr[7]/td")
