    ...
    if P == 0:
        ...
        try:
            if operation == ('+'):
                ...
                print(Fore.YELLOW + " Look in the menu below on instructions for operations.")
                print(" ------------------------------------------------------")
        ...
        print(Fore.YELLOW + " Look in the menu under this message which of the numbers you need to enter.")
        print(" ---------------------------------------------------------------------------")
